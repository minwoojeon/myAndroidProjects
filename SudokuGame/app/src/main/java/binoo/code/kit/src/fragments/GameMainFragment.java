...
public final class GameMainFragment extends Fragment {
        ...
        btn.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                if (event.getAction() == MotionEvent.ACTION_DOWN){
                    ...
                    AppManager.getInstance().getItems().put("level", 1);
                    ...
                    AppManager.getInstance().peekActivity().getSupportFragmentManager().beginTransaction().
                            replace(R.id.mainLinear, new GameChooseLoad(), AppGlobalData.ACTIVITY_MAIN_FRAME_LAYOUT).commit();
                }
                return false;
            }
        });
